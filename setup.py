...
setup(name='icqsol',
      ...
      install_requires=['pytriangle>=1.0.7', 'pycsg>=0.3.7'],
      dependency_links=['http://github.com/pletzer/pytriangle/tarball/master#egg=pytriangle-1.0.7',
                        'http://github.com/pletzer/pycsg/tarball/master#egg=pycsg-0.3.7',
      ],
